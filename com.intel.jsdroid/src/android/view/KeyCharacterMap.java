...
public class KeyCharacterMap
{
    ...
    private static SparseArray<KeyCharacterMap> sInstances 
        = new SparseArray<KeyCharacterMap>();
    ...
    public static KeyCharacterMap load(int keyboard)
    {
        synchronized (sLock) {
            ...
            KeyCharacterMap ref = sInstances.get(keyboard);
            if (ref != null) {
                result = ref;
                if (result != null) {
                    return result;
            ...
            sInstances.put(keyboard, result);
            return result;
        }
    }
    ...
    private static int ctor_native(int id) {
        return id;
    }
    ...
    private static boolean getKeyData_native(int ptr, int keycode,
            KeyData results) {
        if (COMMENUMAP.get(keycode) != null) {
            for (int i = 0; i < COMMENUMAP.get(keycode).length(); i++) {
                results.meta[i] = COMMENUMAP.get(keycode).charAt(i);
            }
            return true;
        } else {
            return false;
    ...
    private static HashMap<Integer, String> COMMENUMAP = new HashMap<Integer, String>();
    /**
    ...
    public static boolean[] deviceHasKeys(int[] keyCodes) {
        System.out.println("Stub" + " Function : deviceHasKeys");
        return null;
    }
    ...
    @MayloonStubAnnotation()
    public static boolean deviceHasKey(int keyCode) {
        System.out.println("Stub" + " Function : deviceHasKey");
        return true;
    }
}

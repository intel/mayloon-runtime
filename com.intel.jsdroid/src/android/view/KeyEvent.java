...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_DEL             = 46;
    ...
    public static final int KEYCODE_MENU            = 118; // F7 in MayLoon
    ...
    public final boolean dispatch(Callback receiver, DispatcherState state,
        ...
        switch (mAction) {
            case ACTION_DOWN: {
            	if(DEBUG) System.out.println("Event dispatch ACTION_DOWN");
                mFlags &= ~FLAG_START_TRACKING;
            ...
            case ACTION_UP:
            	if(DEBUG)System.out.println("Event dispatch ACTION_UP");
    ...
    public int getUnicodeChar(int meta) {
        System.out.println("Stub" + " Function : getUnicodeChar");
        return 0;
    }
    ...
    @MayloonStubAnnotation()
    public boolean isPrintingKey() {
        System.out.println("Stub" + " Function : isPrintingKey");
        return true;
    }
}

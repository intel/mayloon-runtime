...
public class GestureDetector {
    ...
    private void init(Context context, boolean ignoreMultitouch) {
        ...
        mIsLongpressEnabled = false; // MayLoon change
    ...
    public void setOnDoubleTapListener(Object onDoubleTapListener) {
        System.out.println("Stub" + " Function : setOnDoubleTapListener");
        return;
    }

...
public final class ViewTreeObserver {
    ...
    final void dispatchOnGlobalFocusChange(View oldFocus, View newFocus) {
        ...
        final ArrayList<OnGlobalFocusChangeListener> listeners = mOnGlobalFocusListeners;
        if (listeners != null) {
    ...
    public final void dispatchOnGlobalLayout() {
        ...
        // could mutate the list by calling the various add/remove methods. This prevents
        // the array from being modified while we iterate it.
        final ArrayList<OnGlobalLayoutListener> listeners = mOnGlobalLayoutListeners;
        if (listeners != null) {
    ...
    public final boolean dispatchOnPreDraw() {
        ...
        final ArrayList<OnPreDrawListener> listeners = mOnPreDrawListeners;
        if (listeners != null) {
    ...
    final void dispatchOnTouchModeChanged(boolean inTouchMode) {
        ...
        // could mutate the list by calling the various add/remove methods. This prevents
        // the array from being modified while we iterate it.
        final ArrayList<OnTouchModeChangeListener> listeners =
                mOnTouchModeChangeListeners;
        if (listeners != null) {
            for (OnTouchModeChangeListener listener : listeners) {
                if (listener instanceof TabHost) {
    ...
    final boolean hasComputeInternalInsetsListeners() {
        final ArrayList<OnComputeInternalInsetsListener> listeners =
                mOnComputeInternalInsetsListeners;

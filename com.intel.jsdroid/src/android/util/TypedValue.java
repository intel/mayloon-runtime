...
public class TypedValue {
	...
	public final float getFloat() {
		return MathUtils.myIntBitsToFloat(data);
	}
	...
	public static int complexToDimensionPixelOffset(int data,
		...
		return (int) Math.floor(applyDimension((data >> COMPLEX_UNIT_SHIFT)
	...
	public static int complexToDimensionPixelSize(int data,
        ...
        final int res = (int) Math.floor(f + 0.5f); // j2s convert (int) to Math.round 2013.2.3
		if (res != 0)
			return res;
		if (value == 0)
			return 0;
	...
	public static final String coerceToString(int type, int data) {
		...
		case TYPE_ATTRIBUTE:
			return "?" + data;
		case TYPE_FLOAT:
			return Float.toString(MathUtils.myIntBitsToFloat(data));
		case TYPE_DIMENSION:
    ...
    public float getDimension(DisplayMetrics metrics) {
        System.out.println("Stub" + " Function : getDimension");
        return 0;
    };

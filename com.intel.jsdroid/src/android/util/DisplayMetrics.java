	...
	*/
	...
	public String toString() {
		return "DisplayMetrics{density=" + density + ", width=" + widthPixels
				+ ", height=" + heightPixels + ", scaledDensity="
				+ scaledDensity + ", xdpi=" + xdpi + ", ydpi=" + ydpi + "}";
	}
	...
	private static int getDeviceDensity() {
	    ...
	    int density = DENSITY_DEFAULT;
	    // In browser, our width is large, we should use high density so that we will
	    // get same size UI with android emulator.
	    /**
	     * @j2sNative

...
//    private static final String LOG = Uri.class.getSimpleName();
    ...
    protected static final String NOT_CACHED = new String("NOT CACHED");
...
//            PathPart.EMPTY, Part.NULL, Part.NULL);
    ...
    protected final static int NOT_CALCULATED = -2;

    /**
     * Error message presented when a user tries to treat an opaque URI as
     * hierarchical.
     */
    protected static final String NOT_HIERARCHICAL
...
//    }
    ...
    public static final class Builder {
        ...
        public Uri build() {
            if (opaquePart != null) {
                ...
                try{
	                Constructor cstr  = Class.forName("android.net.HierarchicalUri").getConstructor(
	                		String.class,android.net.Uri.Part.class,android.net.Uri.PathPart.class,
	                		android.net.Uri.Part.class,android.net.Uri.Part.class);
	                return (HierarchicalUri)cstr.newInstance(scheme, authority, path, query, fragment);
                }catch(Exception e){
    ...
    protected static final int NULL_TYPE_ID = 0;
    ...
    protected static final byte[] REPLACEMENT = { (byte) 0xFF, (byte) 0xFD };

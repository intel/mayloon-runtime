...
public class Intent implements Parcelable, Cloneable {
	...
	public static class ShortcutIconResource {
		 ...
		 */
		public static ShortcutIconResource fromContext(Context context,
				int resourceId) {
	 ...
	 * be set with the {@link com.intel.jsdroid.sample.R.styleable#AndroidManifestActivity_noHistory
	 * noHistory} attribute.
	 */
	 ...
	 * {@link com.intel.jsdroid.sample.R.styleable#AndroidManifestActivity_launchMode
	...
	public static Intent parseUri(String uri, int flags) throws URISyntaxException {
		...
		while (!uri.startsWith("end", i)) {
			...
			// extra
				...
				else throw new URISyntaxException("URISyntaxException","e");
			}
		...
		if (i >= 0) {
			...
			if (uri.regionMatches(i, "extras(", 0, 7)) {
				...
				while (i < closeParen) {
					...
					case 'c':
						intent.mExtras
								.putChar(key, Uri.decode(value).charAt(0));
						break;
					case 'd':
						intent.mExtras
	...
	public String toUri(int flags) {
		...
		if (mCategories != null) {
			for (String category : mCategories) {
				uri.append("category=").append(Uri.encode(category))
						.append(';');
			}
		}
		if (mType != null) {
		...
		if (mFlags != 0) {
			uri.append("launchFlags=0x").append(Integer.toHexString(mFlags))
					.append(';');
		}
		if (mPackage != null) {
	...
	public void writeToParcel(Parcel out, int i) {
	    out.setAction(mAction);
        out.setData(mData);
        out.setType(mType);
        out.setFlags(0);
        out.setComponent(mComponent);
        out.addCategory(mCategories);
	}
	...
	public ActivityInfo resolveActivityInfo(PackageManager pm, int flags) {
		...
		if (mComponent != null) {
			try {
				...
				Log.e(TAG, "resolveActivityInfo, NameNotFoundException");
			}
		} else {
			...
			if (info != null) {
				...
				Log.e(TAG, "resolveActivityInfo, mComponent is null");
			}
		}
...
//         resources.parseBundleExtra("extra", attrs, intent.mExtras);
 ...
 return intent;
    ...
    public void readFromParcel(Parcel in) {
        mAction = in.getAction();
        mData = in.getData();
        mType = in.getType();
        mFlags = in.getFlags();
        mComponent = in.getComponent();
        mCategories = (HashSet<String>) in.getCategories();
    ...
    public void Intent(String action) {
        System.out.println("Stub" + " Function : Intent");
        return;
    }
     ...
     */
    @MayloonStubAnnotation()
    private void Intent(Intent o, boolean all) {
        System.out.println("Stub" + " Function : Intent");
        return;
    }
    ...
    @MayloonStubAnnotation()
    public Intent getIntent() {
        System.out.println("Stub" + " Function : getIntent");
        return null;
    }

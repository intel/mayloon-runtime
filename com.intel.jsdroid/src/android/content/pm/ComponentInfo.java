 ...
 * {@link ActivityInfo}, {@link ServiceInfo}). This class is not intended to be
 * used by itself; it is simply here to share common definitions between all
 * application components. As such, it does not itself implement Parcelable, but
 * does provide convenience methods to assist in the implementation of
 * Parcelable in subclasses.
 */
public class ComponentInfo extends PackageItemInfo {
	/**
	 * Global information about the application/package this component is a part
	 * of.
	 */
	 ...
	 * <var>applicationInfo.processName</var>.
	 */
	public String processName;

	/**
	 * A string resource identifier (in the package's resources) containing a
	 * user-readable description of the component. From the "description"
	 ...
	 * this value can be overriden by the one in its parent
	 ...
	 * Comes from {@link com.intel.jsdroid.sample.R.attr#exported android:exported} of the
	 * &lt;activity&gt;, &lt;receiver&gt;, &lt;service&gt;, or &lt;provider&gt;
	 * tag.
	 */
	...
	protected ComponentInfo(Parcel source) {
        ...
        descriptionRes=source.descriptionRes;

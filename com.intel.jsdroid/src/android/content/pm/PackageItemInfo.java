...
public class PackageItemInfo {
	...
	/**
	 * A drawable resource identifier (in the package's resources) of this
	 * component's logo. Logos may be larger/wider than icons and are displayed
	 * by certain UI elements in place of a name or name/icon combination. From
	 * the "logo" attribute or, if not set, 0.
	 */
	public int logo;
	...
	/**
	 * Retrieve the current textual label associated with this item. This will
	 * call back on the given PackageManager to load the label from the
	 * application.
	 * 
	 * @param pm
	 ...
	 *            item.
	 * 
	 * @return Returns a CharSequence containing the item's label. If the item
	 *         does not have a label, its name is returned.
	 */
	...
	/**
	 * Retrieve the current graphical icon associated with this item. This will
	 * call back on the given PackageManager to load the icon from the
	 * application.
	 * 
	 * @param pm
	 ...
	 *            item.
	 * 
	 * @return Returns a Drawable containing the item's icon. If the item does
	 *         not have an icon, the item's default icon is returned such as the
	 ...
	 *            item.
	 * 
	 * @return Returns a Drawable containing the item's default icon such as the
	 *         default activity icon.
	 * 
	 * @hide
	 */
	...
	/**
	 * Retrieve the current graphical logo associated with this item. This will
	 * call back on the given PackageManager to load the logo from the
	 * application.
	 * 
	 * @param pm
	 ...
	 *            item.
	 * 
	 * @return Returns a Drawable containing the item's logo. If the item does
	 *         not have a logo, this method will return null.
	 */
	public Drawable loadLogo(PackageManager pm) {
		if (logo != 0) {
			Drawable d = pm
					.getDrawable(packageName, logo, getApplicationInfo());
			if (d != null) {
				return d;
			}
		}
	 ...
	 *            item.
	 * 
	 * @return Returns a Drawable containing the item's default logo or null if
	 *         no default logo is available.
	 * 
	 * @hide
	 */
	 ...
	 * 
	 * @param pm
	 *            A PackageManager from which the XML can be loaded; usually the
	 *            PackageManager from which you originally retrieved this item.
	 * @param name
	 *            Name of the meta-date you would like to load.
	 * 
	 * @return Returns an XmlPullParser you can use to parse the XML file
	 *         assigned as the given meta-data. If the meta-data name is not
	 *         defined or the XML resource could not be found, null is returned.
	 */
	...
	protected void dumpFront(Printer pw, String prefix) {
		...
		if (labelRes != 0 || nonLocalizedLabel != null || icon != 0) {
			pw.println(prefix + "labelRes=0x" + Integer.toHexString(labelRes)
					+ " nonLocalizedLabel=" + nonLocalizedLabel + " icon=0x"

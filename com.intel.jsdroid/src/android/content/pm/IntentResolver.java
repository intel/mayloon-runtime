...
public class IntentResolver<F extends IntentFilter, R extends Object> {
    ...
    public void addFilter(F f) {
        if (localLOGV) {
            System.out.println(TAG + "Adding filter: " + f);
            f.dump(new LogPrinter(Log.VERBOSE, TAG, Log.LOG_ID_SYSTEM), "      ");
            System.out.println(TAG +"    Building Lookup Maps:");
        }
    ...
    void removeFilterInternal(F f) {
        if (localLOGV) {
            System.out.println(TAG + "Removing filter: " + f);
            f.dump(new LogPrinter(Log.VERBOSE, TAG, Log.LOG_ID_SYSTEM), "      ");
            System.out.println(TAG + "    Cleaning Lookup Maps:");
        }
    ...
    boolean dumpMap(PrintWriter out, String titlePrefix, String title,
        ...
        for (Map.Entry<String, ArrayList<F>> e : map.entrySet()) {
            ...
            for (int i=0; i<N; i++) {
                ...
                if (printFilter) {
                    if (printer == null) {
                        printer = new PrintWriterPrinter();
                    }
    ...
    public List<R> queryIntent(Intent intent, String resolvedType, boolean defaultOnly) {
        ...
        if (scheme != null) {
        	System.out.println("mSchemeToFilter:"+mSchemeToFilter.size()+mSchemeToFilter);

...
public class Matrix {
    ...
    public static void multiplyMM(float[] result, int resultOffset,
        ...
        for (int i = 0 ; i < 4 ; i++) {
            ...
            float ri0 = lhs[0 * 4 + 0 + lhsOffset] * rhs_i0;
            float ri1 = lhs[0 * 4 + 1 + lhsOffset] * rhs_i0;
            float ri2 = lhs[0 * 4 + 2 + lhsOffset] * rhs_i0;
            float ri3 = lhs[0 * 4 + 3 + lhsOffset] * rhs_i0;
            for (int j = 1 ; j < 4 ; j++) {
    ...
    public static void multiplyMV(float[] resultVec,
        ...
        resultVec[0 + resultVecOffset] = lhsMat[lhsMatOffset + 0 + 4 * 0] * rhsVec[rhsVecOffset + 0] + lhsMat[lhsMatOffset + 0 + 4 * 1] * rhsVec[rhsVecOffset + 1] + lhsMat[lhsMatOffset + 0 + 4 * 2] * rhsVec[rhsVecOffset + 2] + lhsMat[lhsMatOffset + 0 + 4 * 3] * rhsVec[rhsVecOffset + 3];
        resultVec[1 + resultVecOffset] = lhsMat[lhsMatOffset + 1 + 4 * 0] * rhsVec[rhsVecOffset + 0] + lhsMat[lhsMatOffset + 1 + 4 * 1] * rhsVec[rhsVecOffset + 1] + lhsMat[lhsMatOffset + 1 + 4 * 2] * rhsVec[rhsVecOffset + 2] + lhsMat[lhsMatOffset + 1 + 4 * 3] * rhsVec[rhsVecOffset + 3];
        resultVec[2 + resultVecOffset] = lhsMat[lhsMatOffset + 2 + 4 * 0] * rhsVec[rhsVecOffset + 0] + lhsMat[lhsMatOffset + 2 + 4 * 1] * rhsVec[rhsVecOffset + 1] + lhsMat[lhsMatOffset + 2 + 4 * 2] * rhsVec[rhsVecOffset + 2] + lhsMat[lhsMatOffset + 2 + 4 * 3] * rhsVec[rhsVecOffset + 3];
        resultVec[3 + resultVecOffset] = lhsMat[lhsMatOffset + 3 + 4 * 0] * rhsVec[rhsVecOffset + 0] + lhsMat[lhsMatOffset + 3 + 4 * 1] * rhsVec[rhsVecOffset + 1] + lhsMat[lhsMatOffset + 3 + 4 * 2] * rhsVec[rhsVecOffset + 2] + lhsMat[lhsMatOffset + 3 + 4 * 3] * rhsVec[rhsVecOffset + 3];
    }
    ...
    public static void setLookAtM(float[] rm, int rmOffset,
        ...
        // Normalize f
        float rlf = 1.0f / Matrix.getLength(fx, fy, fz);
        fx *= rlf;
        fy *= rlf;
        fz *= rlf;
        ...
        // and normalize s
        float rls = 1.0f / Matrix.getLength(sx, sy, sz);
        sx *= rls;
        sy *= rls;
        sz *= rls;

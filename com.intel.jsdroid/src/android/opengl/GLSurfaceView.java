...
public class GLSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        if (LOG_SURFACE) {
            Log.d("GLSurfaceView", "surfaceChanged:" + "w:" + w +" h:" + h);
        }
...
//                        + EGLLogWrapper.getErrorString(egl.eglGetError()));
    ...
    private class EglHelper {
         ...
         * In MayLoon, we don't have concept of EGL, here we
         * just use this function to implement the necessary logic.
         * @param configSpec
         */
        public void start() {
            if (LOG_EGL) {
...
//            }
            ...
            /*
             * Create a HTML5 canvas for this SurfaceView
             */
            ...
            // Currently we only support GLES2.0, so initialize GLES20 interface with canvas' 3d context
            String id = canvas.getHTML5CanvasID();
...
//            return true;
            ...
            // There is no swap buffer function in WebGL, here we just call glFinish()
            // TODO: Handle context lost case?
            GLES20.glFinish();
            return true;
        }
...
//            }
        ...
        public void finish() {
            ...
            // set GLES20' static 3d context to null
            /**
             * @j2sNative
...
//            }
        ...
        // Workaround: We do not need this member, but it seems that J2S will rename our local variable,
        // so that we can't find them in j2s native code, so we save it in class member
        public String mCanvasID = null;
    }
    ...
    class GLThread extends Thread {
        ...
        /**
         * Workaround: It seems that J2S compiler has bugs for inner class: if the function will not be called
         * anywhere, j2s will not generate js code for this function. We workaround it by call the function
         * somewhere to let j2s generate js code for it.
         * @param isExecute
         * @throws InterruptedException
         */
        private void mainLoop(boolean isExecute) throws InterruptedException {
            if (!isExecute) return;
        ...
        private void initMainLoopState() throws InterruptedException {
            // Workaround for J2S compiler
            this.mainLoop(false);
        ...
        // These members are for main loop.

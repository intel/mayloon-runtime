...
/*        pw.print(prefix); pw.print("intent={");
    ...
    */}
    ...
    ServiceRecord(ActivityManager ams,
            ComponentName name,
        ...
        baseDir = (sInfo.applicationInfo!=null)? sInfo.applicationInfo.sourceDir:null;
        resDir = (sInfo.applicationInfo!=null)? sInfo.applicationInfo.publicSourceDir:null;
        dataDir = (sInfo.applicationInfo!=null)? sInfo.applicationInfo.dataDir:null;

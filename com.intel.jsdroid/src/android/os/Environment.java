...
public class Environment {
    ...
    /**
     *  external meego storage directory
     *
     * @hide
     */  
    private static final File MEEGO_EXTERNAL_STORAGE_DIRECTORY
            = getDirectory("MEEGO_EXTERNAL_STORAGE", "/media");
    ...
    /**
     * Gets the meego external storage directory.
     *
     * @hide
     */
    public static File getHostExternalStorageDirectory() {
        return MEEGO_EXTERNAL_STORAGE_DIRECTORY;
    }
    ...
    public static String getExternalStorageState() {
        ...
        return path != null ?  MEDIA_MOUNTED : MEDIA_REMOVED;*/

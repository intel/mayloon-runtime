...
import android.view.HTML5Event;
...
//        if (holder != null) {
  //          setPreviewDisplay(holder.getSurface());
    	...
    	fgcanvasid = holder.getCanvasID();
    	Log.v("fgcanvasid",fgcanvasid);
    	String viewRootId = "";
            /**
             * @j2sNative
...
//     		ViewRoot viewRoot = ViewRoot.thisViewRoot(viewRootId);
//     		int keyCode = -1;
...
//     		 */ {}
//     		viewRoot.onPredefinedKeyDown(keyCode,keyEvent);
//       
...
//        }
    ...
    public final void startPreview() {
    	 ...
    	 * navigator.webkitGetUserMedia("video", function(s){url = webkitURL.createObjectURL(s);console.log("create url: " + url);video.src = url;}, function(e){console.log("error: " + e.name);});
        ...
        public void handleMessage(Message msg) {
            ...
            case CAMERA_MSG_POSTVIEW_FRAME:
                ...
                if (mPostviewCallback != null) {
                    ...
                    Log.v("mPostviewCallback.onPictureTaken","");
                }
                return;
...
//        native_takePicture();
     ...
     //  * ctx.fillRect(0, 0, width, height);
        ...
        msg.what = CAMERA_MSG_COMPRESSED_IMAGE;
        msg.obj = imageByte;
        mEventHandler.sendMessage(msg);
        Log.v("sendMessage","CAMERA_MSG_COMPRESSED_IMAGE");

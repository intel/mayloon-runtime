...
public class Region implements Parcelable {
    ...
    public static class Op {
        public static final Op DIFFERENCE = new Op(0);
        public static final Op INTERSECT = new Op(1);
        public static final Op UNION = new Op(2);
        public static final Op XOR = new Op(3);
        public static final Op REVERSE_DIFFERENCE = new Op(4);
        public static final Op REPLACE = new Op(5);
        ...
        public static Op valueOf(String value) {
            if ("DIFFERENCE".equals(value)) {
                ...
                return Op.INTERSECT;
            } else if ("UNION".equals(value)) {
                return Op.UNION;
            } else if ("XOR".equals(value)) {
                return Op.XOR;
            } else if ("REVERSE_DIFFERENCE".equals(value)) {
                return Op.REVERSE_DIFFERENCE;

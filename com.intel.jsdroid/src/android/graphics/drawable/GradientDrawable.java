...
public class GradientDrawable extends Drawable {
    ...
    /**
     * Create a new gradient drawable given an orientation and an array of
    ...
    /**
     * Set the stroke width and color for the drawable. If width is zero, then
     * no stroke is drawn.
     */
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            if (name.equals("size")) {
                ...
                if (hasCenterColor) {
                    ...
                    // Since 0.5f is default value, try to take the one that
                    // isn't 0.5f

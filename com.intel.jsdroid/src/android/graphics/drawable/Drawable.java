...
//		System.out.println("in Drawable.draw");
	}
	 ...
	 * [{@link com.intel.jsdroid.sample.R.attr#state_focused},
	 *  {@link com.intel.jsdroid.sample.R.attr#state_pressed}].
	 *
	 ...
	 * {@link com.intel.jsdroid.sample.R.attr#state_focused},
	 * {@link com.intel.jsdroid.sample.R.attr#state_selected}, etc.
	 * Some drawables may modify their imagery based on the selected state.
    ...
    public static Drawable createFromResourceStream(Resources res, TypedValue value,
        ...
        */
        ...
        Bitmap  bm = BitmapFactory.decodeResourceStream(res, value, is, pad, opts, srcName);
        if (bm != null) {
    ...
    /**
     * Create a drawable from a resource, using the given resources and
     * value to determine density information.
     */
    public static Drawable createFromResource(Resources res, TypedValue value, String srcName, int id, BitmapFactory.Options opts) {
        ...
        */
        ...
        //if (opts == null) opts = new BitmapFactory.Options();
        //opts.inScreenDensity = DisplayMetrics.DENSITY_DEVICE;
        AssetFileDescriptor afd = res.openRawResourceFd(id);
        Bitmap  bm = BitmapFactory.decodeResourceFd(afd, id);
        if (bm != null) {
            Res_png_9patch np = bm.getNinePatch();
    ...
    private static Drawable drawableFromBitmap(Resources res, Bitmap bm, Res_png_9patch np,
	...
	public void inflate(Resources r, XmlResourceParser parser,
			AttributeSet attrs) {
	...
	void inflateWithAttributes(Resources r, XmlResourceParser parser,
	 ...
	 */
	public static Drawable createFromXml(Resources r, XmlResourceParser parser)
    ...
    public static Drawable createFromXmlInner(Resources r,
        ...
        try {
            /**
             * Use java reflection here. Don't directly call these classes'
             * constructor This might cause a J2S class loading problem.
             */
            if (name.equals("color")) {
                drawable = (Drawable) Class.forName(
                        "android.graphics.drawable.ColorDrawable")
                        .newInstance();
            } else if (name.equals("layer-list")) {
                drawable = (Drawable) Class.forName("android.graphics.drawable.LayerDrawable")
                        .newInstance();
                ...
                drawable = (Drawable) Class.forName("android.graphics.drawable.StateListDrawable")
                        .newInstance();
            } else if (name.equals("clip")) {
                drawable = (Drawable) Class.forName("android.graphics.drawable.ClipDrawable")
                        .newInstance();
    ...
    public Region getTransparentRegion() {
        ...
        Log.e("Drawable", "Not implemented yet!");
        return null;
    }
    ...
    public void setColorFilter(int color, PorterDuff.Mode mode) {
        System.out.println("Stub" + " Function : setColorFilter");
        return;
    }
    ...
    public void clearColorFilter() {
        System.out.println("Stub" + " Function : clearColorFilter");
        return;
    }

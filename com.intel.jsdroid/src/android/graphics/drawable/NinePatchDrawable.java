...
public class NinePatchDrawable extends Drawable {
     ...
     */
    @Deprecated
    public NinePatchDrawable(Bitmap bitmap, Res_png_9patch chunk, Rect padding, String srcName) {
     ...
     */
    public NinePatchDrawable(Resources res, Bitmap bitmap, Res_png_9patch chunk,
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs)
        ...
        try {
            ...
            bitmap = BitmapFactory.decodeResourceStream(r, value, is, padding, options, ais.getAssetInt().getAssetSource());
        ...
        setNinePatchState(new NinePatchState(
                new NinePatch(bitmap, bitmap.getNinePatch(), "XML 9-patch"),
                padding, dither), r);
        mNinePatchState.mTargetDensity = mTargetDensity;

...
public class TableLayout extends LinearLayout {
    ...
    public TableLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.android.internal.R.styleable.TableLayout);

        String stretchedColumns = a.getString(com.android.internal.R.styleable.TableLayout_stretchColumns);
        ...
        String shrinkedColumns = a.getString(com.android.internal.R.styleable.TableLayout_shrinkColumns);
        ...
        String collapsedColumns = a.getString(com.android.internal.R.styleable.TableLayout_collapseColumns);
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        super.addView(child, index, params, true);
        requestRowsLayout();
    }
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        protected void setBaseAttributes(TypedArray a,
            ...
            if (a == null) {
                throw new NullPointerException("TableLayout.setBaseAttributes -> a is null");
            }
    ...
    public void LayoutParams(MarginLayoutParams source) {
        System.out.println("Stub" + " Function : LayoutParams");
        return;
    }
     ...
     */
    @MayloonStubAnnotation()
    public void LayoutParams(int w, int h, float initWeight) {
        System.out.println("Stub" + " Function : LayoutParams");
        return;
    }
     ...
     */
    @MayloonStubAnnotation()
    public void LayoutParams(int w, int h) {
        System.out.println("Stub" + " Function : LayoutParams");
        return;
    }
}

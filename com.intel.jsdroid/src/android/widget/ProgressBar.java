...
public class ProgressBar extends View {
    ...
    private static String TAG = "ProgressBar<<";
    int mMinWidth;
    int mMaxWidth;
    int mMinHeight;
    int mMaxHeight;
    ...
    public ProgressBar(Context context) {
        this(context, null);
        System.out.println(TAG+"ProgressBar(Context context)");
    }
    
    public ProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, com.android.internal.R.attr.progressBarStyle);
        System.out.println(TAG+"ProgressBar(Context context, AttributeSet attrs)");
    }

    public ProgressBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        System.out.println(TAG+"ProgressBar(Context context, AttributeSet attrs, int defStyle)");
        initProgressBar();
        
        //FIXEME: potential bug! Please use 'com.android.internal.R' instead of 'R'!!! -wenhao
        TypedArray a =
            context.obtainStyledAttributes(attrs,com.android.internal.R.styleable.ProgressBar, defStyle, 0);
        
        mNoInvalidate = true;
        
        Drawable drawable = a.getDrawable(com.android.internal.R.styleable.ProgressBar_progressDrawable);
        if (drawable != null) {
        	System.out.println(TAG+"tileify");
        ...
        final int resID = a.getResourceId(
                ...
                com.android.internal.R.anim.linear_interpolator); // default to linear interpolator
        if (resID > 0) {
    ...
    private Drawable tileifyIndeterminate(Drawable drawable) {
        // MayLoon: 2013.2.17 not sure AnimationDrawable worked
    ...
    private void initProgressBar() {
        ...
        mDuration = 4000;
        mBehavior = 0;//AlphaAnimation.RESTART;
        mMinWidth = 24;
        mMaxWidth = 48;
        mMinHeight = 24;
        mMaxHeight = 48;
    ...
    private void refreshProgress(int id, int progress, boolean fromUser) {      
    ...
    void startAnimation() {
        ...
        // MayLoon Workaround
        // [Class] instanceof [SomeInterface] is not worked in JS
        // The method should be worked in JS:
        // class.__proto__["isRunning"] != null
        Method run = null;
        boolean instanceofAnimatable = true;
        try {
            Class clazz = mIndeterminateDrawable.getClass();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (d != null) {
            ...
            if (mShouldStartAnimationDrawable && instanceofAnimatable && run != null) {
                ((Animatable) d).start();
                mShouldStartAnimationDrawable = false;
            }
        }

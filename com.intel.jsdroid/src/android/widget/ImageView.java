...
public class ImageView extends View {
    ...
    */
    ...
    public void setImageBitmap(Bitmap bm) {
        ...
        // Workaround: It seems j2s can't handle method overload well in j2s.
        if (bm == null) {
            setImageDrawable(new BitmapDrawable(mContext.getResources(), (Bitmap) null));
        } else {
...
//                }
                Log.e("ImageView", "Unable to open content: " + mUri);
    ...
    private void updateDrawable(Drawable d) {
        if (mDrawable != null) {
            ...
            unscheduleDrawable(mDrawable, null);
        }
        mDrawable = d;
        if (d != null) {
            d.setCallback(this);
            ...
            d.setLevel(mLevel);
            // Workaround: may be not right
            final Rect r = d.copyBounds();
            ...
            if ( width == 0 && height == 0 ) {
                ...
                mDrawableWidth = r.right - r.left;
                mDrawableHeight = r.bottom - r.top;
            }
            applyColorMod();
            configureBounds();
        }
    ...
    void ScaleType(int ni) {
        System.out.println("Stub" + " Function : ScaleType");
        return;
    }

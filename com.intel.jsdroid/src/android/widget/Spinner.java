...
public class Spinner extends AbsSpinner implements OnClickListener {
    ...
    public boolean performClick() {
        ...
        Log.d(TAG, "Spinner performClick at time:" + start);
        ...
        if (!handled) {
            ...
            if (mPopup == null) {
                ...
                final DropDownAdapter adapter = new DropDownAdapter(
                        getAdapter());
                ...
                /**
                 * Assuming data in a Spinner don't change
                 */
                mPopup.setSelectedItem(getSelectedItemPosition());
            }
            mPopup.show();
        }

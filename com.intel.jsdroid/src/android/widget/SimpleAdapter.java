...
public class SimpleAdapter extends BaseAdapter /** implements Filterable /**/
{
	...
	private View createViewFromResource(int position, View convertView,
		...
		View v;
		if (convertView == null) {
			// here the third params should be false!
			// but in our implementation, this can't be false
			// because we need to add these nodes to dom tree
			v = mInflater.inflate(resource, parent, false);
			//			if (v instanceof ViewGroup) {
			//				ViewGroup vg = (ViewGroup) v;
			//				v = vg.getChildAt(vg.getChildCount() - 1);
			...
			if (v != null) {
				...
				if (!bound) {
					if (v instanceof Checkable) {
						...
						//						System.out.println("v instanceof TextView");
						// Note: keep the instanceof TextView check at the bottom of these
						// since a lot of views are TextViews (e.g. CheckBoxes).
						setViewText((TextView) v, text);

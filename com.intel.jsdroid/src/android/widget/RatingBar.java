...
public class RatingBar extends AbsSeekBar {
    ...
    public RatingBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                com.android.internal.R.styleable.RatingBar,
                defStyle, 0);
        final int numStars = a.getInt(com.android.internal.R.styleable.RatingBar_numStars,
                mNumStars);
        setIsIndicator(a.getBoolean(com.android.internal.R.styleable.RatingBar_isIndicator,
                !mIsUserSeekable));
        final float rating = a.getFloat(com.android.internal.R.styleable.RatingBar_rating, -1);
        final float stepSize = a.getFloat(com.android.internal.R.styleable.RatingBar_stepSize, -1);
        a.recycle();

...
public class TabWidget extends LinearLayout implements OnFocusChangeListener {
    ...
    public TabWidget(Context context, AttributeSet attrs) {
        ...
        int defStyle = com.android.internal.R.attr.tabWidgetStyle;
		...
		TypedArray view = context.obtainStyledAttributes(attrs,
				com.android.internal.R.styleable.View, defStyle, 0);

		final int N = view.getIndexCount();
		for (int i = 0; i < N; i++) {
			int attr = view.getIndex(i);
			switch (attr) {

			case com.android.internal.R.styleable.View_id:
				int id  = view.getResourceId(attr, NO_ID);
				this.setId(id);
				break;
			}
		}*/
    ...
    public View getChildTabViewAt(int index) {
        ...
        if (view == null) throw new NullPointerException("Tab View is null!");
        return view;
    }

...
//	}
	...
	public RadioGroup(Context context, AttributeSet attrs) {
		...
		int value = attributes.getResourceId(
				R.styleable.RadioGroup_checkedButton, View.NO_ID);
//		System.out.println("mCheckedId: " + value);
		if (value != View.NO_ID) {
			mCheckedId = value;
		}
...
//		mGroupName = "RadioGroup" + this.getUIElementID();
	}
	...
	@Override
	public void addView(View child, int index, ViewGroup.LayoutParams params, boolean modifyDom) {
		if (child instanceof RadioButton) {
			final RadioButton button = (RadioButton) child;
			if (button.isChecked()) {
				mProtectFromCheckedChange = true;
		...
		super.addView(child, index, params, modifyDom);
	}
...
//			System.out.println(checkedView.getUIElementID() + " is set "
//					+ checked);
	...
	private class PassThroughHierarchyChangeListener implements
		...
		public void onChildViewAdded(View parent, View child) {
			if (parent == RadioGroup.this && child instanceof RadioButton) {
				...
				((RadioButton) child)
						.setOnCheckedChangeWidgetListener(mChildOnCheckedChangeListener);
			}
